  ...
  module Compute
    class OneAndOne
      ...
      class Real
        ...
        ##
        # Returns a list of all load balancers on your account
        # URL: [https://cloudpanel-api.1and1.com/documentation/1and1/v1/en/documentation.html#load_balancers_get]
        ##
